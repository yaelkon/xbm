...
class LlavaLlamaForCausalLM(LlamaForCausalLM, LlavaMetaForCausalLM):
    ...
    def forward(
        ...
        output_inputs_embeds: Optional[bool] = None,
        ...
        if output_inputs_embeds:
            return (decoder_output, image_features, labels)
        else:
    ...
    def generate(
        ...
        **kwargs,
        ...
        if output_inputs_embeds:
            return (decoder_output, inputs_embeds)
        else:
            return decoder_output
